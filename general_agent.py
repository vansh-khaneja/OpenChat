...
from utils import rephrase_ans,fetch_api_data,fetch_all_data,inc_insights
...
def general_data_retrieve(state):
    ...
    print(api_key)
    inc_insights("general_insights",api_key)
    ...
    rephrased_ans = rephrase_ans(question,str(finanl_list),api_key,str(chat_history))
